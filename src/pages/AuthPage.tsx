      ...
      <div className="auth-card">
        <div className="auth-header">
          ...
          <p className="auth-subtitle">
            {isLogin ? 'Sign in to manage your job applications' : 'Start tracking your job search'}
          </p>
        </div>
            ...
            {!isLogin && (
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="name" value={fullName} onChange={e => setFullName(e.target.value)} placeholder="John Doe" className="pl-9" />
                </div>
              </div>
            )}
            <div className="space-y-2">
